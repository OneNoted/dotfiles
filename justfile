...
check-scripts:
    shfmt -d dot_config/niri/executable_region-record-toggle.sh dot_config/hypr/executable_screenshot-region.sh bootstrap/bootstrap.sh
    shellcheck dot_config/niri/executable_region-record-toggle.sh dot_config/hypr/executable_screenshot-region.sh bootstrap/bootstrap.sh
