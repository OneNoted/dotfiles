...
check-scripts:
    shfmt -d dot_config/niri/executable_snappers-record-toggle.sh dot_config/hypr/executable_screenshot-region.sh bootstrap/bootstrap.sh bootstrap/nvim.sh dot_local/bin/executable_glide-wayland dot_local/bin/executable_kubectl dot_local/bin/executable_mitmdump dot_local/bin/executable_mitmproxy dot_local/bin/executable_mitmweb dot_local/bin/executable_niri-launch-eww dot_local/bin/executable_niri-session dot_local/bin/executable_niri-session-install-system-bridge dot_local/bin/executable_niri-tmux-session-picker dot_local/bin/executable_nvidia-settings dot_local/bin/executable_portal-session-refresh dot_local/bin/executable_sesh-picker-terminal dot_local/bin/executable_tv dot_local/bin/executable_xdg-open dot_local/bin/executable_yazi-wrapper.sh
